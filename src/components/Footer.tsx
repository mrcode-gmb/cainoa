          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <input
                ...
                className="w-full sm:w-80 h-14 px-5 rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:border-accent focus:ring-4 focus:ring-accent/20 transition-all duration-300 text-base"
